...
var dateFormat = function (str, date) {
  ...
  byui.each(getTime, function (key) {
...
describe('laydate', function () {
  ...
  describe('laydate.render()', function () {
    ...
    describe('options.elem', function () {
      it('selector', function () {
        ...
        expect($('.byui-laydate').length).to.equal(0);
      });
    ...
    describe('options.type', function () {
      ...
      it('is year', function (done) {
        ...
        setTimeout(function () {
          ...
          expect($('.laydate-year-list .byui-this').text()).to.equal(dateFormat('yyyy年'), '默认高亮显示当前年');
      ...
      it('is month', function (done) {
        ...
        setTimeout(function () {
          ...
          expect($('.laydate-month-list .byui-this').attr('lay-ym'))
      ...
      it('is date', function (done) {
        ...
        setTimeout(function () {
          ...
          expect($('.byui-laydate-content .byui-this').attr('lay-ymd'))
      ...
      it('is datetime', function (done) {
        ...
        setTimeout(function () {
          ...
          expect($('.byui-laydate-content .byui-this').attr('lay-ymd')).to.equal(
    ...
    describe('options.format', function () {
      ...
      it('format and error value', function () {
        ...
        // 错误提示
        expect($('.byui-laydate-hint').text()).to.match(/日期格式不合法/);
        expect($('.byui-laydate-hint').text()).to.match(/yyyy~MM~dd/);
      });
      ...
      it('format and number value', function (done) {
        ...
        setTimeout(function () {
          // 错误提示
          expect($('.byui-laydate-hint').length).to.equal(0, '格式正确没有错误提示');
    ...
    describe('options.value', function () {
      ...
      it('yyyy-MM-dd not format value', function () {
        ...
        // 错误提示
        expect($('.byui-laydate-hint').text()).to.match(/日期格式不合法/);
        expect($('.byui-laydate-hint').text()).to.match(/yyyy年MM月dd日/);
      ...
      it('input default value format error', function (done) {
        createNode('<input id="test-input-2" type="text" value="byui">');
      ...
      it('change value', function () {
        ...
        expect($('.byui-this').text()).to.equal('7', '显示默认的7');

        $('.laydate-btns-confirm').click();
        $('#test-div').text('2017-7-10').click();
        expect($('.byui-this').text()).to.equal('10', '显示更新后的10');
      });
    });
    ...
    describe('options.min and options.max', function () {
      it('date string', function () {
        ...
        expect($('.laydate-year-list .byui-this').text()).to.equal('2017年');
      ...
      it('error string', function () {
        ...
        expect($('.byui-laydate-content .byui-this').attr('lay-ymd')).to.equal(dateFormat('yyyy-M-d'), '默认选中日期');

        // 昨天不可用, 判断是为了处理跨月
        var $elem = $('.byui-laydate-content [lay-ymd="' + dateFormat('yyyy-M-d', -1) + '"]');
        if ($elem.length) {
          expect($elem.hasClass('laydate-disabled')).to.be.true;
        }

        // 明天不可用, 判断是为了处理跨月
        $elem = $('.byui-laydate-content [lay-ymd="' + dateFormat('yyyy-M-d', 1) + '"]');
        if ($elem.length) {
          expect($elem.hasClass('laydate-disabled')).to.be.true;
        }
      });
      ...
      it('date number', function () {
        ...
        // 前两天应该是可用, 判断是为了处理跨月
        var $elem = $('.byui-laydate-content [lay-ymd="' + dateFormat('yyyy-M-d', -2) + '"]');
        if ($elem.length) {
          expect($elem.hasClass('laydate-disabled')).to.be.false;
        }

        // 前三天应该是禁用的
        $elem = $('.byui-laydate-content [lay-ymd="' + dateFormat('yyyy-M-d', -3) + '"]');
        if ($elem.length) {
          expect($elem.hasClass('laydate-disabled')).to.be.true;
        }

        // 后两天可用
        $elem = $('.byui-laydate-content [lay-ymd="' + dateFormat('yyyy-M-d', 2) + '"]');
        if ($elem.length) {
          expect($elem.hasClass('laydate-disabled')).to.be.false;
        }
      ...
      it('timestamp', function () {
        ...
        // 前三天可用, 防止跨月
        var $elem = $('.byui-laydate-content [lay-ymd="' + dateFormat('yyyy-M-d', -3) + '"]');
        if ($elem.length) {
          expect($elem.hasClass('laydate-disabled')).to.be.false;
        }

        // 前四天不可用
        $elem = $('.byui-laydate-content [lay-ymd="' + dateFormat('yyyy-M-d', -4) + '"]');
        if ($elem.length) {
          expect($elem.hasClass('laydate-disabled')).to.be.true;
        }
      ...
      it('and options.value', function () {
        ...
        expect($('.byui-laydate-content .byui-this').attr('lay-ymd')).to.equal('2017-7-7', '默认选中日期');
        expect($('.byui-laydate-content [lay-ymd="2017-7-6"]').hasClass('laydate-disabled')).to.be.true;
        expect($('.byui-laydate-content [lay-ymd="2017-7-8"]').hasClass('laydate-disabled')).to.be.true;
      });
    ...
    describe('options.show', function () {
      ...
      it('element trigger show and options.closeStop', function (done) {
        ...
        setTimeout(function () {
          expect($('.byui-laydate').length).to.equal(1);
          done();
        }, 100);
      });
    });
    ...
    describe('options.position', function () {
      it('static', function () {
        ...
        expect($('#test-div').find('.byui-laydate-static').length).to.equal(1);
      });
      ...
      it('fixed', function () {
        ...
        expect($('.byui-laydate').css('position')).to.equal('fixed');
      });
    });
    ...
    describe('options.zIndex', function () {
      it('options.position is fixed', function () {
        ...
        expect($('.byui-laydate').css('zIndex')).to.equal('10086');
      });
    ...
    describe('options.showBottom', function () {
      it('default value', function () {
        ...
        expect($('.byui-laydate-footer').length).to.equal(1);
      });
      ...
      it('is false', function () {
        ...
        expect($('.byui-laydate-footer').length).to.equal(0);
      });
    });
    ...
    describe('options.lang', function () {
      it('default value is cn', function () {
        ...
        var weeks = $('.byui-laydate-content').find('thead th').map(function () {
          return $(this).text();
        }).get();
      ...
      it('error vaue', function () {
        ...
        expect(result.config.lang).to.equal('byui');
      });
    ...
    describe('options.theme', function () {
      ...
      it('error value', function () {
        ...
        expect($('.laydate-theme-byui-test').length).to.equal(1, '自定义主题class存在');
      });
    ...
    describe('options.calendar', function () {
      it('default value', function () {
        ...
        expect($('.byui-this').text()).to.equal('8', '显示数字');
      });
      ...
      it('is true', function () {
        ...
        expect($('.byui-this').text()).to.equal('妇女', '显示妇女节');
      });
      ...
      it('options.lang is en', function () {
        ...
        expect($('.byui-this').text()).to.equal('8', '国际版显示数字');
      });
    });
    ...
    describe('options.mark', function () {
      it('every year', function () {
        ...
        expect($('.byui-this').text()).to.equal('妹子', '显示自定义的妹子');

        // 再看下4月7日
        $('.laydate-btns-confirm').click();
        $('#test-div').text('2017-4-7').click();
        expect($('.byui-this').text()).to.equal('7', '显示日期');
      });
      ...
      it('options.calendar is true', function () {
        ...
        expect($('.byui-this').text()).to.equal('快乐', '显示被mark覆盖的 快乐');
      });
    });
  ...
  describe('#hint', function () {
    it('set string', function () {
      ...
      app.hint('byui');
      expect($('.byui-laydate-hint').text()).to.equal('byui');
    });
    ...
    it('timeout 3000', function (done) {
      ...
      app.hint('byui');
      expect($('.byui-laydate-hint').length).to.equal(1);
      setTimeout(function () {
        expect($('.byui-laydate-hint').length).to.equal(0);
        done();
      }, 3500);
    });
  });
  ...
  describe('lay', function () {
    ...
    describe('lay.elem', function () {
      ...
      it('set attrs', function () {
        ...
        expect($(node).attr('data-name')).to.equal('byui');
      });
    });
  ...
  describe('lay()', function () {
    ...
    it('#addClass', function () {
      ...
      expect($('#test-div').hasClass('byui')).to.be.false;
      expect($node.addClass('byui')).to.deep.equal($node);
      expect($('#test-div').hasClass('byui')).to.be.true;
    });

    it('#removeClass', function () {
      var $node = lay('#test-div');

      lay('#test-div').addClass('byui');
      expect($('#test-div').hasClass('byui')).to.be.true;
      expect($node.removeClass('byui')).to.deep.equal($node);
      expect($('#test-div').hasClass('byui')).to.be.false;
    });

    it('#hasClass', function () {
      expect(lay('#test-div').hasClass('byui')).to.be.false;
      lay('#test-div').addClass('byui');
      expect(lay('#test-div').hasClass('byui')).to.be.true;
      lay('#test-div').removeClass('byui');
      expect(lay('#test-div').hasClass('byui')).to.be.false;
    });

    it('#attr', function () {
      $('#test-div').attr('data-name', 'byui');
      expect(lay('#test-div').attr('data-name')).to.equal('byui');

      var $node = lay('#test-div');
      expect($node.attr('data-name', 'byui-2')).to.deep.equal($node);
      expect(lay('#test-div').attr('data-name')).to.equal('byui-2');
    ...
    it('#removeAttr', function () {
      ...
      lay('#test-div').attr('data-name', 'byui');
      expect(lay('#test-div').attr('data-name')).to.equal('byui');

      expect(lay('#test-div').removeAttr('data-name')).to.deep.equal($node);
      expect(lay('#test-div').attr('data-name')).to.not.equal('byui');
    });
    ...
    it('#val', function () {
      ...
      expect($node.val('byui')).to.deep.equal($node);
      expect($('#test-input').val()).to.equal('byui');
    });
    ...
    it('#append', function () {
      ...
      var node = $('<b />').html('byui').get(0);
      lay('#test-div').append(node);
      expect($('#test-div').html()).to.equal('<b>byui</b>');
    });
