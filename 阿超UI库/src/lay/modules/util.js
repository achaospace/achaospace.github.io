...
byui.define('jquery', function(exports){
  ...
  ,util = {
    ...
    fixbar: function(options){
      var ELEM = 'byui-fixbar', TOP_BAR = 'byui-fixbar-top'
      ...
      ,elem = $(['<ul class="'+ ELEM +'">'
        ,options.bar1 ? '<li class="byui-icon" lay-type="bar1" style="'+ options.bgcolor +'">'+ icon[0] +'</li>' : ''
        ,options.bar2 ? '<li class="byui-icon" lay-type="bar2" style="'+ options.bgcolor +'">'+ icon[1] +'</li>' : ''
        ,'<li class="byui-icon '+ TOP_BAR +'" lay-type="top" style="'+ options.bgcolor +'">'+ icon[2] +'</li>'
      ,'</ul>'].join(''))
