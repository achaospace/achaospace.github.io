/*!
 ...
 @Title: byui.upload 单文件上传 - 全浏览器兼容版
 @Author: Achao
 @License：MIT

 */
 
byui.define(['layer-mobile', 'zepto'] , function(exports){
  "use strict";
  
  var $ = byui.zepto;
  var layer = byui['layer-mobile'];
  var device = byui.device();
  
  var elemDragEnter = 'byui-upload-enter';
  var elemIframe = 'byui-upload-iframe';
  ...
  Upload.prototype.init = function(){
    ...
    var body = $('body'), elem = $(options.elem || '.byui-upload-file');
    ...
    return elem.each(function(index, item){
      ...
      //包裹ui元素
      if(!options.unwrap){
        form = '<div class="byui-box byui-upload-button">' + form + '<span class="byui-upload-icon"><i class="byui-icon">&#xe608;</i>'+ (
