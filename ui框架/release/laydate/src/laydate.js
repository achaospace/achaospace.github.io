/**
 ...
 @Author: Achao
 @Site：http://www.baiyun.com/laydate/
 @License：MIT
...
;!function(){
  ...
  var isLayui = window.baiyun && baiyun.define, ready = {
    getPath: function(){
  ...
  ,laydate = {
    ...
    ,ready: function(fn){
      ...
      isLayui ? baiyun.addcss(path, fn, cssname) : ready.link(path, fn, cssname);
      return this;
    }
  }
  ...
  //字符常量
  ,MOD_NAME = 'laydate', ELEM = '.baiyun-laydate', THIS = 'baiyun-this', SHOW = 'baiyun-show', HIDE = 'baiyun-hide', DISABLED = 'laydate-disabled', TIPS_OUT = '开始日期超出了结束日期<br>建议重新选择', LIMIT_YEAR = [100, 200000]
  
  ,ELEM_STATIC = 'baiyun-laydate-static', ELEM_LIST = 'baiyun-laydate-list', ELEM_SELECTED = 'laydate-selected', ELEM_HINT = 'baiyun-laydate-hint', ELEM_PREV = 'laydate-day-prev', ELEM_NEXT = 'laydate-day-next', ELEM_FOOTER = 'baiyun-laydate-footer', ELEM_CONFIRM = '.laydate-btns-confirm', ELEM_TIME_TEXT = 'laydate-time-text', ELEM_TIME_BTN = '.laydate-btns-time'
  ...
  */
  ...
  Class.prototype.init = function(){
    ...
    that.elemID = 'baiyun-laydate'+ options.elem.attr('lay-key');
  ...
  Class.prototype.render = function(){
    ...
    ,elem = that.elem = lay.elem('div', {
      ...
      ,'class': [
        'baiyun-laydate'
        ,options.range ? ' baiyun-laydate-range' : ''
    ...
    lay.each(new Array(2), function(i){
      ...
      var divHeader = lay.elem('div', {
        'class': 'baiyun-laydate-header'
      })
      
      //左右切换
      ,headerChild = [function(){ //上一年
        var elem = lay.elem('i', {
          'class': 'baiyun-icon laydate-icon laydate-prev-y'
        });
        elem.innerHTML = '&#xe65a;';
        return elem;
      }(), function(){ //上一月
        var elem = lay.elem('i', {
          'class': 'baiyun-icon laydate-icon laydate-prev-m'
        });
        elem.innerHTML = '&#xe603;';
        return elem;
      }(), function(){ //年月选择
        ...
        var elem = lay.elem('i', {
          'class': 'baiyun-icon laydate-icon laydate-next-m'
        });
        elem.innerHTML = '&#xe602;';
        return elem;
      }(), function(){ //下一年
        var elem = lay.elem('i', {
          'class': 'baiyun-icon laydate-icon laydate-next-y'
        });
        elem.innerHTML = '&#xe65b;';
        return elem;
      }()]
      ...
      elemMain[i] = lay.elem('div', {
        'class': 'baiyun-laydate-main laydate-main-list-'+ i
      });
    ...
    if(/^#/.test(options.theme)){
      ...
      ,styleText = [
        '#{{id}} .baiyun-laydate-header{background-color:{{theme}};}'
        ,'#{{id}} .baiyun-this{background-color:{{theme}} !important;}'
  ...
  isLayui ? (
    laydate.ready()
    ,baiyun.define(function(exports){ //layui加载
      laydate.path = baiyun.cache.dir;
