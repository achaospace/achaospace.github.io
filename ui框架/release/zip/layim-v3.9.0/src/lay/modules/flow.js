...
byui.define('jquery', function(exports){
  ...
  var $ = byui.$, Flow = function(options){}
  ,ELEM_MORE = 'byui-flow-more'
  ,ELEM_LOAD = '<i class="byui-anim byui-anim-rotate byui-anim-loop byui-icon ">&#xe63e;</i>';
  ...
  Flow.prototype.load = function(options){
    ...
    ,more = $('<div class="byui-flow-more"><a href="javascript:;">'+ ELEM_TEXT +'</a></div>');
    
    if(!elem.find('.byui-flow-more')[0]){
      elem.append(more);
    }
