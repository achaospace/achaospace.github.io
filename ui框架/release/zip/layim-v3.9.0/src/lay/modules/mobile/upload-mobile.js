/*!
 ...
 @Title: baiyun.upload 单文件上传 - 全浏览器兼容版
 @Author: Achao
 @License：MIT

 */
 
baiyun.define(['layer-mobile', 'zepto'] , function(exports){
  "use strict";
  
  var $ = baiyun.zepto;
  var layer = baiyun['layer-mobile'];
  var device = baiyun.device();
  
  var elemDragEnter = 'baiyun-upload-enter';
  var elemIframe = 'baiyun-upload-iframe';
  ...
  Upload.prototype.init = function(){
    ...
    var body = $('body'), elem = $(options.elem || '.baiyun-upload-file');
    ...
    return elem.each(function(index, item){
      ...
      //包裹ui元素
      if(!options.unwrap){
        form = '<div class="baiyun-box baiyun-upload-button">' + form + '<span class="baiyun-upload-icon"><i class="baiyun-icon">&#xe608;</i>'+ (
