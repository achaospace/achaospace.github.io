/**
 ...
 @Title: baiyun.upload 文件上传
 @Author: Achao
 @License：MIT

 */
 
baiyun.define('layer' , function(exports){
  "use strict";
  ...
  //字符常量
  ,MOD_NAME = 'upload', ELEM = '.baiyun-upload', THIS = 'baiyun-this', SHOW = 'baiyun-show', HIDE = 'baiyun-hide', DISABLED = 'baiyun-disabled'
  
  ,ELEM_FILE = 'baiyun-upload-file', ELEM_FORM = 'baiyun-upload-form', ELEM_IFRAME = 'baiyun-upload-iframe', ELEM_CHOOSE = 'baiyun-upload-choose', ELEM_DRAG = 'baiyun-upload-drag'
  ...
  Class.prototype.file = function(){
    ...
    if(device.ie && device.ie < 10){
      options.elem.wrap('<div class="baiyun-upload-wrap"></div>');
    }
  ...
  Class.prototype.initIE = function(){
    ...
    if(!options.elem.next().hasClass(ELEM_FORM)){
      ...
      options.elem.next('.'+ ELEM_FORM).append(function(){
        var arr = [];
        baiyun.each(options.data, function(key, value){
  ...
  Class.prototype.preview = function(callback){
    ...
    if(window.FileReader){
      baiyun.each(that.chooseFiles, function(index, file){
  ...
  Class.prototype.upload = function(files, type){
    ...
    ,ajaxSend = function(){
      ...
      baiyun.each(items, function(index, file){
    ...
    ,check ,value = function(){
      var arr = [];
      baiyun.each(files || that.chooseFiles, function(i, item){
        arr.push(item.name);
      });
      return arr;
    }()
    ...
    ,args = {
      ...
      ,pushFile: function(){
        ...
        baiyun.each(that.chooseFiles, function(index, item){
    ...
    switch(options.accept){
      ...
      break;
      default: //图片文件
        baiyun.each(value, function(i, item){
  ...
  Class.prototype.events = function(){
    ...
    ,setChooseFile = function(files){
      that.chooseFiles = {};
      baiyun.each(files, function(i, item){
    ...
    ,setChooseText = function(files, filename){
      ...
      elemFile.after('<span class="baiyun-inline '+ ELEM_CHOOSE +'">'+ value +'</span>');
    };
